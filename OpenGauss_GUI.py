...
import psycopg2
import sys
from recognition.detect import detect
...
class MainWindow(QTabWidget):
    ...
    def __init__(self):
        ...
        self.model = self.model_load(weights="C:/Users/86183/Desktop/FaceRecognition-master/weights/last.pt",device=self.device)  # todo 指明模型加载的位置的设备
        self.initUI()
        self.reset_vid()
