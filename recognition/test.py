...
def create_conn():
    database = 'project'  # 选择数据库名称
    user = 'dboper'
    password = 'cqy123456?'
    host = '192.168.136.131'  # 数据库ip
    port = '26000'
                    ...
                    if det is not None and len(det):
                        ...
                        for *xyxy, conf, cls in det:
                            ...
                            if save_img or view_img:  # Add bbox to image
                                ...
                                # print(tmp_lable)
                                # 输出识别时间和人名
                                cleaned_label = tmp_lable[0]
                                timestamp = time.strftime('%Y-%m-%d %H:%M:%S', time.localtime())
                                print(timestamp,cleaned_label)

                                ##写入数据库********************************************************************************
                                conn = create_conn()
                                cur = conn.cursor()  # 创建光标：
                                mstrsql = "insert into Detect values('{}','{}')".format(timestamp,cleaned_label)
                                print(mstrsql)
...
def setOPT():
    ...
    parser.add_argument('--weights', type=str, default="C:/Users/86183/Desktop/yolov5-master/runs/train/exp10/weights/last.pt", help='model.pt path')
    #parser.add_argument('--source', type=str, default="C:/Users/86183/Desktop/FaceRecognition-master/inference/images/1.jpg", help='source')  # file/folder, 0 for webcam
    parser.add_argument('--source', type=str, default='0', help='source')
    parser.add_argument('--output', type=str, default='C:/Users/86183/Desktop/FaceRecognition-master/output', help='output folder')  # output folder
    ...
    parser.add_argument('--facenet-model-path',type=str,default='C:/Users/86183/Desktop/FaceRecognition-master/20180402-114759',help='miss facenet-model')
    parser.add_argument('--svc-path', type=str, default='C:/Users/86183/Desktop/FaceRecognition-master/SVCmodel.pkl',
                        help='miss svc')
    parser.add_argument('--database-path', type=str, default='C:/Users/86183/Desktop/FaceRecognition-master/Database.npz',
                        help='miss database')
...
# def setOPT():
    ...
    # parser = argparse.ArgumentParser()
    # parser.add_argument('--weights', type=str, default='C:/Users/86183/Desktop/FaceRecognition-master/weights/last.pt', help='model.pt path')
    # #parser.add_argument('--source', type=str, default="C:/Users/86183/Desktop/FaceRecognition-master/inference/images/1.jpg" , help='source')  # file/folder, 0 for webcam
    # # parser.add_argument('--output', type=str, default='C:/Users/86183/Desktop/FaceRecognition-master/output',help='output file path with extension')  # output folder
    # parser.add_argument('--source', type=str,default='0',help='source')  # file/folder, 0 for webcam
    # parser.add_argument('--output', type=str, default='C:/Users/86183/Desktop/FaceRecognition-master/output/output.jpg', help='output file path with extension')  # output folder
    # parser.add_argument('--img-size', type=int, default=640, help='inference size (pixels)')
    # parser.add_argument('--conf-thres', type=float, default=0.3, help='object confidence threshold')
    # parser.add_argument('--iou-thres', type=float, default=0.5, help='IOU threshold for NMS')
    # parser.add_argument('--fourcc', type=str, default='mp4v', help='output video codec (verify ffmpeg support)')
...
if __name__ == "__main__":
     ...
     #weights = "C:/Users/86183/Desktop/FaceRecognition-master/weights/last.pt"   #自己训练的
     weights = "C:/Users/86183/Desktop/yolov5-master/runs/train/exp10/weights/last.pt"
     output = "C:/Users/86183/Desktop/FaceRecognition-master/output"    #输出文件保存位置
     source ="C:/Users/86183/Desktop/FaceRecognition-master/inference/images/0.jpg"   #输入检测文件
     # source = "C:/Users/86183/Desktop/FaceRecognition-master/inference/123.mp4"  # 输入检测文件

     picture_path = "C:/Users/86183/Desktop/FaceRecognition-master/pictures" #用户图片数据
     model_path = "C:/Users\86183/Desktop/FaceRecognition-master/20180402-114759"  #facenet模型权重
     database_path = "C:/Users/86183/Desktop/FaceRecognition-master/Database.npz"  #打包成npz文件
     SVCpath = "C:/Users/86183/Desktop/FaceRecognition-master/SVCmodel.pkl" #通过SVM训练保存到pkl
     #face2database(picture_path,model_path,database_path) #step1
     #ClassifyTrainSVC(database_path,SVCpath) #step2
     #recognition_img(model_path, SVCpath, database_path,weights,source,output) #step3（用不着）
